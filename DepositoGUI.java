...
public class DepositoGUI extends JFrame implements ActionListener
{
	...
	public DepositoGUI()
	{
        ...
        // JTextFields
		panel1.add(new JLabel("TRANSACCIONES"));
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		{
			datos = obtenerDatos();
			tabla=tfTipo.getText();
			if(datos.equals("VACIO"))
				respuesta = "Algun campo esta vacio...";
			else
				respuesta = bancoad.capturar(tabla,datos);
